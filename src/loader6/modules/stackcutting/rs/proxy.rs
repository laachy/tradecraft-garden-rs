    ...
    unsafe {
        ...
        *(get_frame().sub(8) as *mut _) = call.spoof_me.ret_addr;
        ...
        if call.argc == 0 {
            ...
            result = mem::transmute::<_, CALL3>(call.function)(call.args[0], call.args[1], call.args[2]);
        } else if call.argc == 4 {
            result = mem::transmute::<_, CALL4>(call.function)(call.args[0], call.args[1], call.args[2], call.args[3]);
        } else {
            result = 0;
        }
